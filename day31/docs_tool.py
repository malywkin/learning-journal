...
if __name__ == "__main__":
    # Сборка индекса + смок-поиск (виден вклад реранкера: score, а не только cos).
    build_index()
    print("\n=== смок-поиск: 'как мы делали RAG с цитатами и порогом' ===")
    for r in search_docs("как мы делали RAG с цитатами и порогом", k=3):
